...
export default function Home() {
  return (
    <div className="flex items-center justify-center w-full h-screen bg-[#ecf2f8]">
      <main className=" w-[820px] h-[300px] flex flex-row bg-white rounded-xl">
        <div className="relative w-[300px] h-full ">
          <Image
            src="/drawers.jpg"
            alt="drawers"
            fill // Makes the image take up the full space of its parent
            className="object-fill rounded-l-xl" // Ensures the image covers the area
          />
        </div>
        <div className="p-6 w-[600px] flex flex-col">
          ...
          <div className="flex flex-row mt-5 ">
            ...
            />
            <div className="justify-between flex-row w-full flex ml-5 ">
              ...
              <div className="flex mr-5 rounded-full bg-[#9eafc2] w-[30px] h-[30px] items-center justify-center">
                <Popover>
                  <PopoverTrigger>
                    <svg
                  ...
                  <PopoverContent className="bg-[#48556a] w-full rounded-xl h-auto p-5">
